...
== Install
  ...
  script/plugin install git://github.com/randomutterings/s3_db_assets_backup.git -r rails_2.x
...
<b>When running script/generate s3_backup I get "No such file or directory - /home/ubuntu/cotr/lib/tasks/assets_backup.rake"</b>

You need to create a tasks directory inside your lib directory
